...
<div class="container">
    <hr class="hrc">
    <hr class="hrc2">
    <h2 class="hrc3">Vote</h2>
    <h4 class="grey montserrat" style="text-align:center;">Voter pour le serveur et recevez des récompences !</h4>
    <br>
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="col-xs-12">
                    <ul class="nav nav-pills nav-justified thumbnail setup-panel">
                        <li  class="black active">
                            <a href="#step-1">
                                <h4 class="list-group-item-heading black"><?= $Lang->get('VOTE__STEP_TITLE') ?> 1</h4>
                                <p class="list-group-item-text black"><?= $Lang->get('VOTE__STEP_SET_USER') ?></p>
                            </a>
                        </li>
                        <li class="disabled">
                            <a href="#step-2">
                ...
                <div class="col-xs-12">
                    <div class="col-md-12 well setup-content text-center">
                        ...
                        <form data-ajax="true" action="<?= $this->Html->url(['action' => 'setUser']) ?>" method="post" data-callback-function="afterSetUser">
                            ...
                            <br><br>
                            <button class="btn btn-danger" type="submit">Passer a l'étape suivante</button>
                        </form>
